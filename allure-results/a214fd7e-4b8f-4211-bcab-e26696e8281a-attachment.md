...
```
Error: locator.textContent: Error: strict mode violation: locator('#user-message') resolved to 3 elements:
...
> 5  |     const beforetext= await page.locator('#user-message').textContent();
     |                                                           ^ Error: locator.textContent: Error: strict mode violation: locator('#user-message') resolved to 3 elements:
