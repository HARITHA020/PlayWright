...
Expected substring: "You have entered 'haritha' !"
Received string:    ""
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#prompt-demo')
    12 × locator resolved to <p id="prompt-demo" class="ml-10 mb-20 mt-20"></p>
       - unexpected value ""
...
> 39 |     await expect(page.locator("#prompt-demo")).toContainText("You have entered 'haritha' !");
     |                                                ^ Error: expect(locator).toContainText(expected) failed
  40 | });
```