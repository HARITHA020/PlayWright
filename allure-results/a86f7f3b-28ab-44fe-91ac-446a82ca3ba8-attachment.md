...
```
Error: page.goForward: Protocol error (Page.getNavigationHistory): Not attached to an active page
Call log:
...
```ts
  ...
  10 |     console.log("Title:", await page.title());
  11 |     console.log("URL:", page.url());
  12 |     //console.log("Content:", await page.content());
